...
tireID         = 152.154943091895336;    // Internal diameter (ID) -- How wide is the inside opening? 
...
rimHeight      = 7;        // The height of the rim portion of the wheel. 
...
spokeInset        = [9,0];      // The [inner,outer] inset of the spoke area from the surface
...
hubDiameter          = 20
;    // The diameter of the hub portion of the wheel
...
baseFilletRadius     = 7;     // The radius of the fillet (rounded part) between the hub and wheel. 
topFilletRadius      = 0.5;     // The radius of the fillet (rounded part) at the top of the hub. 
...
shaftFlatDiameter    = 4.5;          // The diameter of the motor shaft at the flat, or shaftDiameter for no flat.
...
setScrewTrap         = [5.6, 2.5]; // Size [indiameter, thickness] of set screw nut. The depth is set automatically.
setScrewNutDiameter  = 5.6;        // The "diameter" of the captive nut, from flat to flat (the "in-diameter")
